...
This codebase was created to demonstrate a fully fledged fullstack application built with **hapi pal** including CRUD operations, authentication, routing, pagination, and more.
